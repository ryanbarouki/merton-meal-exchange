...
const FormData = __webpack_require__(/*! form-data */ "../node_modules/superagent/node_modules/form-data/lib/form_data.js");
...
exports.handler = async (event, context) => {
  ...
  return client.query(q.Paginate(q.Match(q.Collection('Meals')))).then(response => {
